      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        const participantItems = participants.length
          ? participants
              .map(
                (participant) => `
                  <li class="participant-chip">
                    ...
                    <button type="button" class="participant-remove-btn" data-activity-name="${name}" data-email="${participant}" aria-label="Remove ${participant}">
                      ×
                    </button>
                  </li>
                `
              ...
              .join("")
          : '<li class="participant-chip participant-chip-empty">Nenhum participante inscrito ainda.</li>';
